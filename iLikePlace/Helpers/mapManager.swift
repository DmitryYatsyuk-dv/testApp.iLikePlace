...
//  FavoritePlaces
//
//  Created by Lucky on 09/02/2020.
...
class MapManager {
    ...
    private var routeInfo: MapViewController?
    ...
    // Check the availability of geolocation services
    ...
    // Verify application authorization to use geolocation services
    ...
    // Build a route from the user's location to the place
    func getDirection(for mapView: MKMapView, previousLocation: (CLLocation) -> ()) {
        ...
        directions.calculate { (response, error) in
            ...
            for route in response.routes {
                ...
                self.routeInfo?.infoRoute.isHidden = false
                self.routeInfo?.infoRoute.text = """
                Distance to place: \(distance) km.
                Travel time is: \(timeInterval) min.
                """
            }
        }
    }
    ...
    // Tracking user geolocation while driving
    ...
    // Determining the center of the displayed map
